...
La CLI è in `src/cli/` (package). Se hai idee per renderla più chiara, con più opzioni o con output migliore, fai pure. La 2.0.1 Stable è solo terminale, quindi la CLI è la faccia principale del tool — e ora deve funzionare uguale su Windows, Linux e macOS.
